...
template <typename SEL0, typename SEL1, typename SEL2, typename SEL3> struct GPIO_IOMUX {

  void write(SEL0 opt) volatile { write(opt, 0x00); }
  void write(SEL1 opt) volatile { write(opt, 0x04); }
  void write(SEL2 opt) volatile { write(opt, 0x08); }
  void write(SEL3 opt) volatile { write(opt, 0x0c); }

  uint32_t reg;

private:
  void write(auto opt, int offset) volatile { reg = (static_cast<uint32_t>(opt) << (0x10 + offset)) | (0xffff); }
};
...
enum class GPIO1A_IOMUX_L_SEL_3 : uint32_t { GPIO1_A3, I2S1_SCLKTXM0, UART3_CTSNM0, SCR_IO, PCIE30X1_WAKENM2, ACODEC_DACCLK };
enum class GPIO1A_IOMUX_L_SEL_2 : uint32_t { GPIO1_A2, I2S1_MCLKM0, UART3_RTSNM0, SCR_CLK, PCIE30X1_PERSTNM2 };
enum class GPIO1A_IOMUX_L_SEL_1 : uint32_t { GPIO1_A1, I2C3_SCLM0, UART3_TXM0, CAN1_TXM0, AUDIOpwmROUT, ACODEC_ADCCLK, AUDIOpwmLOUTN };
enum class GPIO1A_IOMUX_L_SEL_0 : uint32_t { GPIO1_A0, I2C3_SDAM0, UART3_RXM0, CAN1_RXM0, AUDIOpwmLOUT, ACODEC_ADCDATA, AUDIOpwmLOUTP };

enum class GPIO1A_IOMUX_H_SEL_7 : uint32_t { GPIO1_A7, I2S1_SDO0M0, UART4_CTSNM0, SCR_DET, AUDIOpwmROUTN, ACODEC_DAC_DATAL };
enum class GPIO1A_IOMUX_H_SEL_6 : uint32_t { GPIO1_A6, I2S1_LRCKRXM0, UART4_TXM0, PDM_CLK0M0, AUDIOpwmROUTP };
enum class GPIO1A_IOMUX_H_SEL_5 : uint32_t { GPIO1_A5, I2S1_LRCKTXM0, UART4_RTSNM0, SCR_RST, PCIE30X1_CLKREQNM2, ACODEC_DACSYNC };
...
enum class GPIO1B_IOMUX_L_SEL_1 : uint32_t { GPIO1_B1, I2S1_SDO2M0, I2S1_SDI2M0, PDM_SDI2M0, PCIE20_WAKENM2, ACODEC_ADC_SYNC };
enum class GPIO1B_IOMUX_L_SEL_0 : uint32_t { GPIO1_B0, I2S1_SDO1M0, I2S1_SDI3M0, PDM_SDI3M0, PCIE20_CLKREQNM2, ACODEC_DAC_DATAR };
...
enum class GPIO2D_IOMUX_L_SEL_2 : uint32_t { GPIO2_D2, LCDC_D2, BT656_D2M0, SPI0_CS0M1, PCIE30X1_CLKREQNM1, I2S1_LRCKTXM2 };
enum class GPIO2D_IOMUX_L_SEL_1 : uint32_t { GPIO2_D1, LCDC_D1, BT656_D1M0, SPI0_MOSIM1, PCIE20_WAKENM1, I2S1_SCLKTXM2 };
enum class GPIO2D_IOMUX_L_SEL_0 : uint32_t { GPIO2_D0, LCDC_D0, BT656_D0M0, SPI0_MISOM1, PCIE20_CLKREQNM1, I2S1_MCLKM2 };

enum class GPIO2D_IOMUX_H_SEL_7 : uint32_t { GPIO2_D7, LCDC_D7, BT656_D7M0, SPI2_MISOM1, UART8_TXM1, I2S1_SDO0M2 };
enum class GPIO2D_IOMUX_H_SEL_6 : uint32_t { GPIO2_D6, LCDC_D6, BT656_D6M0, SPI2_MOSIM1, PCIE30X2_PERSTNM1, I2S1_SDI3M2 };
enum class GPIO2D_IOMUX_H_SEL_5 : uint32_t { GPIO2_D5, LCDC_D5, BT656_D5M0, SPI2_CS0M1, PCIE30X2_WAKENM1, I2S1_SDI2M2 };
enum class GPIO2D_IOMUX_H_SEL_4 : uint32_t { GPIO2_D4, LCDC_D4, BT656_D4M0, SPI2_CS1M1, PCIE30X2_CLKREQNM1, I2S1_SDI1M2 };
...
enum class GPIO3C_IOMUX_L_SEL_1 : uint32_t { GPIO3_C1, LCDC_HSYNC, BT1120_D13, SPI1_MOSIM1, PCIE20_PERSTNM1, I2S1_SDO2M2 };
...
enum class GPIO4A_IOMUX_H_SEL_7 : uint32_t { GPIO4_A7, CAM_CLKOUT0, EBC_SDCE1, GMAC1_RXD0M1, SPI3_CS1M0, I2S1_LRCKRXM1 };
enum class GPIO4A_IOMUX_H_SEL_6 : uint32_t { GPIO4_A6, ISP_FLASHTRIGOUT, EBC_SDCE0, GMAC1_TXENM1, SPI3_CS0M0, I2S1_SCLKRXM1 };
...
enum class GPIO4B_IOMUX_L_SEL_3 : uint32_t { GPIO4_B3, I2C4_SCLM0, EBC_GDOE, ETH1_REFCLKO25MM1, SPI3_CLKM0, I2S2_SDOM1 };
...
enum class GPIO4C_IOMUX_L_SEL_3 : uint32_t { GPIO4_C3, PWM15_M1, SPI3_MOSIM1, CAN1_TXM1, PCIE30X2_WAKENM2, I2S3_SCLKM1 };
enum class GPIO4C_IOMUX_L_SEL_2 : uint32_t { GPIO4_C2, PWM14_M1, SPI3_CLKM1, CAN1_RXM1, PCIE30X2_CLKREQNM2, I2S3_MCLKM1 };
enum class GPIO4C_IOMUX_L_SEL_1 : uint32_t { GPIO4_C1, CIF_CLKIN, EBC_SDCLK, GMAC1_MCLKINOUTM1, UART1_CTSNM1, I2S2_SCLKRXM1 };
...
enum class GPIO4C_IOMUX_H_SEL_4 : uint32_t { GPIO4_C4, EDPDP_HPDINM0, SPDIF_TXM2, SATA2_ACTLED, PCIE30X2_PERSTNM2, I2S3_LRCKM1 };
...
using GPIO0A_IOMUX_L = GPIO_IOMUX<GPIO0A_IOMUX_L_SEL_0, GPIO0A_IOMUX_L_SEL_1, GPIO0A_IOMUX_L_SEL_2, GPIO0A_IOMUX_L_SEL_3>;
using GPIO0A_IOMUX_H = GPIO_IOMUX<GPIO0A_IOMUX_H_SEL_4, GPIO0A_IOMUX_H_SEL_5, GPIO0A_IOMUX_H_SEL_6, GPIO0A_IOMUX_H_SEL_7>;

using GPIO0B_IOMUX_L = GPIO_IOMUX<GPIO0B_IOMUX_L_SEL_0, GPIO0B_IOMUX_L_SEL_1, GPIO0B_IOMUX_L_SEL_2, GPIO0B_IOMUX_L_SEL_3>;
using GPIO0B_IOMUX_H = GPIO_IOMUX<GPIO0B_IOMUX_H_SEL_4, GPIO0B_IOMUX_H_SEL_5, GPIO0B_IOMUX_H_SEL_6, GPIO0B_IOMUX_H_SEL_7>;

using GPIO0C_IOMUX_L = GPIO_IOMUX<GPIO0C_IOMUX_L_SEL_0, GPIO0C_IOMUX_L_SEL_1, GPIO0C_IOMUX_L_SEL_2, GPIO0C_IOMUX_L_SEL_3>;
using GPIO0C_IOMUX_H = GPIO_IOMUX<GPIO0C_IOMUX_H_SEL_4, GPIO0C_IOMUX_H_SEL_5, GPIO0C_IOMUX_H_SEL_6, GPIO0C_IOMUX_H_SEL_7>;
...
using GPIO1A_IOMUX_L = GPIO_IOMUX<GPIO1A_IOMUX_L_SEL_3, GPIO1A_IOMUX_L_SEL_2, GPIO1A_IOMUX_L_SEL_1, GPIO1A_IOMUX_L_SEL_0>;
using GPIO1A_IOMUX_H = GPIO_IOMUX<GPIO1A_IOMUX_H_SEL_7, GPIO1A_IOMUX_H_SEL_6, GPIO1A_IOMUX_H_SEL_5, GPIO1A_IOMUX_H_SEL_4>;

using GPIO1B_IOMUX_L = GPIO_IOMUX<GPIO1B_IOMUX_L_SEL_3, GPIO1B_IOMUX_L_SEL_2, GPIO1B_IOMUX_L_SEL_1, GPIO1B_IOMUX_L_SEL_0>;
using GPIO1B_IOMUX_H = GPIO_IOMUX<GPIO1B_IOMUX_H_SEL_7, GPIO1B_IOMUX_H_SEL_6, GPIO1B_IOMUX_H_SEL_5, GPIO1B_IOMUX_H_SEL_4>;

using GPIO1C_IOMUX_L = GPIO_IOMUX<GPIO1C_IOMUX_L_SEL_3, GPIO1C_IOMUX_L_SEL_2, GPIO1C_IOMUX_L_SEL_1, GPIO1C_IOMUX_L_SEL_0>;
using GPIO1C_IOMUX_H = GPIO_IOMUX<GPIO1C_IOMUX_H_SEL_7, GPIO1C_IOMUX_H_SEL_6, GPIO1C_IOMUX_H_SEL_5, GPIO1C_IOMUX_H_SEL_4>;

using GPIO1D_IOMUX_L = GPIO_IOMUX<GPIO1D_IOMUX_L_SEL_3, GPIO1D_IOMUX_L_SEL_2, GPIO1D_IOMUX_L_SEL_1, GPIO1D_IOMUX_L_SEL_0>;
using GPIO1D_IOMUX_H = GPIO_IOMUX<GPIO1D_IOMUX_H_SEL_7, GPIO1D_IOMUX_H_SEL_6, GPIO1D_IOMUX_H_SEL_5, GPIO1D_IOMUX_H_SEL_4>;

using GPIO2A_IOMUX_L = GPIO_IOMUX<GPIO2A_IOMUX_L_SEL_3, GPIO2A_IOMUX_L_SEL_2, GPIO2A_IOMUX_L_SEL_1, GPIO2A_IOMUX_L_SEL_0>;
using GPIO2A_IOMUX_H = GPIO_IOMUX<GPIO2A_IOMUX_H_SEL_7, GPIO2A_IOMUX_H_SEL_6, GPIO2A_IOMUX_H_SEL_5, GPIO2A_IOMUX_H_SEL_4>;

using GPIO2B_IOMUX_L = GPIO_IOMUX<GPIO2B_IOMUX_L_SEL_3, GPIO2B_IOMUX_L_SEL_2, GPIO2B_IOMUX_L_SEL_1, GPIO2B_IOMUX_L_SEL_0>;
using GPIO2B_IOMUX_H = GPIO_IOMUX<GPIO2B_IOMUX_H_SEL_7, GPIO2B_IOMUX_H_SEL_6, GPIO2B_IOMUX_H_SEL_5, GPIO2B_IOMUX_H_SEL_4>;

using GPIO2C_IOMUX_L = GPIO_IOMUX<GPIO2C_IOMUX_L_SEL_3, GPIO2C_IOMUX_L_SEL_2, GPIO2C_IOMUX_L_SEL_1, GPIO2C_IOMUX_L_SEL_0>;
using GPIO2C_IOMUX_H = GPIO_IOMUX<GPIOX_RESERVED, GPIO2C_IOMUX_H_SEL_6, GPIO2C_IOMUX_H_SEL_5, GPIO2C_IOMUX_H_SEL_4>;

using GPIO2D_IOMUX_L = GPIO_IOMUX<GPIO2D_IOMUX_L_SEL_3, GPIO2D_IOMUX_L_SEL_2, GPIO2D_IOMUX_L_SEL_1, GPIO2D_IOMUX_L_SEL_0>;
using GPIO2D_IOMUX_H = GPIO_IOMUX<GPIO2D_IOMUX_H_SEL_7, GPIO2D_IOMUX_H_SEL_6, GPIO2D_IOMUX_H_SEL_5, GPIO2D_IOMUX_H_SEL_4>;

using GPIO3A_IOMUX_L = GPIO_IOMUX<GPIO3A_IOMUX_L_SEL_3, GPIO3A_IOMUX_L_SEL_2, GPIO3A_IOMUX_L_SEL_1, GPIO3A_IOMUX_L_SEL_0>;
using GPIO3A_IOMUX_H = GPIO_IOMUX<GPIO3A_IOMUX_H_SEL_7, GPIO3A_IOMUX_H_SEL_6, GPIO3A_IOMUX_H_SEL_5, GPIO3A_IOMUX_H_SEL_4>;

using GPIO3B_IOMUX_L = GPIO_IOMUX<GPIO3B_IOMUX_L_SEL_3, GPIO3B_IOMUX_L_SEL_2, GPIO3B_IOMUX_L_SEL_1, GPIO3B_IOMUX_L_SEL_0>;
using GPIO3B_IOMUX_H = GPIO_IOMUX<GPIO3B_IOMUX_H_SEL_7, GPIO3B_IOMUX_H_SEL_6, GPIO3B_IOMUX_H_SEL_5, GPIO3B_IOMUX_H_SEL_4>;

using GPIO3C_IOMUX_L = GPIO_IOMUX<GPIO3C_IOMUX_L_SEL_3, GPIO3C_IOMUX_L_SEL_2, GPIO3C_IOMUX_L_SEL_1, GPIO3C_IOMUX_L_SEL_0>;
using GPIO3C_IOMUX_H = GPIO_IOMUX<GPIO3C_IOMUX_H_SEL_7, GPIO3C_IOMUX_H_SEL_6, GPIO3C_IOMUX_H_SEL_5, GPIO3C_IOMUX_H_SEL_4>;

using GPIO3D_IOMUX_L = GPIO_IOMUX<GPIO3D_IOMUX_L_SEL_3, GPIO3D_IOMUX_L_SEL_2, GPIO3D_IOMUX_L_SEL_1, GPIO3D_IOMUX_L_SEL_0>;
using GPIO3D_IOMUX_H = GPIO_IOMUX<GPIO3D_IOMUX_H_SEL_7, GPIO3D_IOMUX_H_SEL_6, GPIO3D_IOMUX_H_SEL_5, GPIO3D_IOMUX_H_SEL_4>;

using GPIO4A_IOMUX_L = GPIO_IOMUX<GPIO4A_IOMUX_L_SEL_3, GPIO4A_IOMUX_L_SEL_2, GPIO4A_IOMUX_L_SEL_1, GPIO4A_IOMUX_L_SEL_0>;
using GPIO4A_IOMUX_H = GPIO_IOMUX<GPIO4A_IOMUX_H_SEL_7, GPIO4A_IOMUX_H_SEL_6, GPIO4A_IOMUX_H_SEL_5, GPIO4A_IOMUX_H_SEL_4>;

using GPIO4B_IOMUX_L = GPIO_IOMUX<GPIO4B_IOMUX_L_SEL_3, GPIO4B_IOMUX_L_SEL_2, GPIO4B_IOMUX_L_SEL_1, GPIO4B_IOMUX_L_SEL_0>;
using GPIO4B_IOMUX_H = GPIO_IOMUX<GPIO4B_IOMUX_H_SEL_7, GPIO4B_IOMUX_H_SEL_6, GPIO4B_IOMUX_H_SEL_5, GPIO4B_IOMUX_H_SEL_4>;

using GPIO4C_IOMUX_L = GPIO_IOMUX<GPIO4C_IOMUX_L_SEL_3, GPIO4C_IOMUX_L_SEL_2, GPIO4C_IOMUX_L_SEL_1, GPIO4C_IOMUX_L_SEL_0>;
using GPIO4C_IOMUX_H = GPIO_IOMUX<GPIO4C_IOMUX_H_SEL_7, GPIO4C_IOMUX_H_SEL_6, GPIO4C_IOMUX_H_SEL_5, GPIO4C_IOMUX_H_SEL_4>;
